const cyberProjects = [
  {
    ...
    description:
      "Implementação prática de criptografia simétrica AES com foco em integridade e confidencialidade.",
   ...
   /*{
    ...
    description:
      "Geração de chaves e criptografia usando RSA — demonstra conhecimento em criptografia assimétrica.",
  ...
  }, */
  {
    ...
    description:
      "Gerador de senhas fortes e configuráveis — utilitário prático para hardening de contas.",
    techs: ["JavaScript", "Security", "UI"],
    image: "img/Gerador de senha.png",
  },
  {
    name: "OSINT Tools",
    url: "https://github.com/Darkghostly/OSINT-Tools",
    description:
      "hub de ferramentas de investigação OSINT com coletores e playbooks de inteligência.",
  ...
  },
  {
    ...
    description:
      "Sistema de monitoramento de autenticação em Python inspirado em SIEMs, capaz de detectar padrões de força bruta via análise de logs SSH, com regras configuráveis e alertas automáticos.",
...
function ensureProjectCardExists() {
  ...
  document
    ...
    .addEventListener("click", closeProjectCard);
}
...
function animateCameraToTarget(camera, targetVec3, duration = 700) {
  ...
  const dir = new THREE.Vector3()
    .subVectors(camera.position, targetVec3)
    .normalize();
...
function animateCameraRestore(camera, savedState, duration = 600) {
  ...
  const endTarget = savedState.target
    ? savedState.target.clone()
